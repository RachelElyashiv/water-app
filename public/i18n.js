...
const TR = {
  ...
  cal_title:       { he:"לוח חודשי", en:"Monthly calendar", ar:"التقويم الشهري", de:"Monatskalender", fr:"Calendrier mensuel", es:"Calendario mensual", hi:"मासिक कैलेंडर" },
  cal_legend:      { he:"ירוק = הושג היעד · טורקיז = חלקי · ⚠ = כאב", en:"Green = goal met · teal = partial · ⚠ = pain", ar:"أخضر = تحقق الهدف · فيروزي = جزئي · ⚠ = ألم", de:"Grün = Ziel erreicht · Türkis = teilweise · ⚠ = Schmerz", fr:"Vert = objectif atteint · turquoise = partiel · ⚠ = douleur", es:"Verde = meta lograda · turquesa = parcial · ⚠ = dolor", hi:"हरा = लक्ष्य पूरा · टील = आंशिक · ⚠ = दर्द" },
  insight_title:   { he:"תובנה: שתייה מול כאב", en:"Insight: hydration vs pain", ar:"رؤية: الترطيب مقابل الألم", de:"Einblick: Hydration vs. Schmerz", fr:"Analyse : hydratation et douleur", es:"Análisis: hidratación y dolor", hi:"अंतर्दृष्टि: हाइड्रेशन बनाम दर्द" },
  insight_compare: { he:"בימים עם כאב שתית בממוצע {a} ל׳, לעומת {b} ל׳ בימים ללא כאב.", en:"On days with pain you drank {a} L on average, vs {b} L on pain-free days.", ar:"في أيام الألم شربت {a} لتر بالمتوسط، مقابل {b} لتر في الأيام بلا ألم.", de:"An Schmerztagen tranken Sie im Schnitt {a} L, an schmerzfreien {b} L.", fr:"Les jours de douleur, vous avez bu {a} L en moyenne, contre {b} L sans douleur.", es:"En días con dolor bebiste {a} L de media, frente a {b} L en días sin dolor.", hi:"दर्द वाले दिनों में आपने औसतन {a} ली. पिया, बनाम बिना दर्द के दिनों में {b} ली." },
  insight_less:    { he:"שתייה נמוכה יותר בימים עם כאב — כדאי להקפיד על היעד.", en:"Lower intake on pain days — worth keeping to your goal.", ar:"شرب أقل في أيام الألم — يُستحسن الالتزام بالهدف.", de:"Weniger Trinken an Schmerztagen — Ziel besser einhalten.", fr:"Moins d’hydratation les jours de douleur — tenez votre objectif.", es:"Menos ingesta en días de dolor — conviene cumplir la meta.", hi:"दर्द वाले दिनों में कम सेवन — लक्ष्य का पालन बेहतर।" },
  insight_none_lnk:{ he:"לא נמצא קשר ברור בין שתייה נמוכה לכאב בתקופה זו.", en:"No clear link between low intake and pain in this period.", ar:"لا يوجد ارتباط واضح بين قلة الشرب والألم في هذه الفترة.", de:"Kein klarer Zusammenhang zwischen wenig Trinken und Schmerz in diesem Zeitraum.", fr:"Pas de lien clair entre faible hydratation et douleur sur cette période.", es:"Sin vínculo claro entre baja ingesta y dolor en este periodo.", hi:"इस अवधि में कम सेवन और दर्द के बीच स्पष्ट संबंध नहीं।" },
  insight_no_pain: { he:"לא תועדו אירועי כאב ב-30 הימים האחרונים.", en:"No pain events recorded in the last 30 days.", ar:"لا نوبات ألم مسجلة في آخر 30 يومًا.", de:"Keine Schmerzereignisse in den letzten 30 Tagen.", fr:"Aucun épisode de douleur enregistré ces 30 derniers jours.", es:"Sin episodios de dolor en los últimos 30 días.", hi:"पिछले 30 दिनों में कोई दर्द घटना दर्ज नहीं।" },
  insight_need:    { he:"עדיין אין מספיק נתונים להשוואה.", en:"Not enough data yet to compare.", ar:"لا توجد بيانات كافية للمقارنة بعد.", de:"Noch nicht genug Daten zum Vergleich.", fr:"Pas encore assez de données pour comparer.", es:"Aún no hay datos suficientes para comparar.", hi:"तुलना के लिए अभी पर्याप्त डेटा नहीं।" },
  insight_note:    { he:"זו תצפית מהנתונים שלך בלבד, ואינה קביעה רפואית.", en:"This is an observation from your own data, not a medical conclusion.", ar:"هذه ملاحظة من بياناتك فقط، وليست استنتاجًا طبيًا.", de:"Dies ist eine Beobachtung aus Ihren Daten, keine medizinische Aussage.", fr:"Ceci est une observation de vos données, pas une conclusion médicale.", es:"Es una observación de tus datos, no una conclusión médica.", hi:"यह केवल आपके डेटा से एक अवलोकन है, चिकित्सा निष्कर्ष नहीं।" },
  ob_welcome_title:{ he:"ברוכים הבאים ל-2.5ל׳", en:"Welcome to 2.5L", ar:"مرحبًا بك في 2.5 ل", de:"Willkommen bei 2.5L", fr:"Bienvenue sur 2.5L", es:"Bienvenido a 2.5L", hi:"2.5L में आपका स्वागत है" },
  ob_welcome_text: { he:"יומן קטן שיעזור לך לשתות מספיק — למניעת אבני כליות. נגדיר את זה ב-3 צעדים קצרים.", en:"A little journal to help you drink enough — to prevent kidney stones. Let's set it up in 3 quick steps.", ar:"مذكرة صغيرة تساعدك على شرب ما يكفي — للوقاية من حصى الكلى. لنُعدّها في 3 خطوات.", de:"Ein kleines Tagebuch, damit du genug trinkst — gegen Nierensteine. In 3 kurzen Schritten.", fr:"Un petit journal pour boire assez — prévenir les calculs rénaux. Configurons-le en 3 étapes.", es:"Un pequeño diario para beber lo suficiente — prevenir cálculos renales. Configurémoslo en 3 pasos.", hi:"पर्याप्त पानी पीने में मदद के लिए एक छोटी डायरी — पथरी की रोकथाम। 3 आसान चरणों में सेट करें।" },
  ob_goal_text:    { he:"אם הרופא נתן לך יעד — הזיני אותו. אחרת, נחשב הערכה לפי הגוף שלך.", en:"If your doctor gave you a goal, enter it. Otherwise, we'll estimate from your body.", ar:"إذا أعطاك طبيبك هدفًا فأدخله. وإلا سنقدّره حسب جسمك.", de:"Wenn dein Arzt ein Ziel gab, trage es ein. Sonst schätzen wir es.", fr:"Si votre médecin a fixé un objectif, saisissez-le. Sinon, nous l'estimons.", es:"Si tu médico te dio una meta, introdúcela. Si no, la estimamos.", hi:"यदि डॉक्टर ने लक्ष्य दिया है तो दर्ज करें। अन्यथा हम अनुमान लगाएंगे।" },
  ob_calc_hint:    { he:"לא יודעת? חשבי לפי משקל:", en:"Not sure? Estimate by weight:", ar:"غير متأكد؟ احسب حسب الوزن:", de:"Unsicher? Nach Gewicht schätzen:", fr:"Vous ne savez pas ? Estimez selon le poids :", es:"¿No sabes? Estima por peso:", hi:"पता नहीं? वज़न से अनुमान लगाएँ:" },
  ob_back:         { he:"הקודם", en:"Back", ar:"السابق", de:"Zurück", fr:"Retour", es:"Atrás", hi:"पीछे" },
  ob_next:         { he:"הבא", en:"Next", ar:"التالي", de:"Weiter", fr:"Suivant", es:"Siguiente", hi:"आगे" },
  ob_skip:         { he:"דלג", en:"Skip", ar:"تخطّي", de:"Überspringen", fr:"Passer", es:"Omitir", hi:"छोड़ें" },
  ob_finish:       { he:"בוא נתחיל", en:"Let's start", ar:"لنبدأ", de:"Los geht's", fr:"C'est parti", es:"Empezar", hi:"शुरू करें" },
  ob_done:         { he:"הכול מוכן! 💧", en:"All set! 💧", ar:"كل شيء جاهز! 💧", de:"Alles bereit! 💧", fr:"Tout est prêt ! 💧", es:"¡Todo listo! 💧", hi:"सब तैयार! 💧" },
